export const abi = [
    ...
    inputs: [
      { internalType: "address", name: "linkToken", type: "address" },
      {
        components: [
          ...
          { internalType: "uint16", name: "subscriptionDepositMinimumRequests", type: "uint16" },
          { internalType: "uint72", name: "subscriptionDepositJuels", type: "uint72" },
        ],
  ...
  { inputs: [], name: "CannotRemoveWithPendingRequests", type: "error" },
  {
    inputs: [{ internalType: "bytes32", name: "requestId", type: "bytes32" }],
    name: "DuplicateRequestId",
    type: "error",
  },
  { inputs: [], name: "EmptyRequestData", type: "error" },
  { inputs: [{ internalType: "uint32", name: "limit", type: "uint32" }], name: "GasLimitTooBig", type: "error" },
  { inputs: [{ internalType: "bytes32", name: "id", type: "bytes32" }], name: "IdentifierIsReserved", type: "error" },
  {
    inputs: [{ internalType: "uint96", name: "currentBalanceJuels", type: "uint96" }],
    name: "InsufficientBalance",
    type: "error",
  },
  { inputs: [], name: "InvalidCalldata", type: "error" },
  { inputs: [], name: "InvalidConsumer", type: "error" },
  { inputs: [{ internalType: "uint8", name: "value", type: "uint8" }], name: "InvalidGasFlagValue", type: "error" },
  ...
  { inputs: [], name: "MustBeSubscriptionOwner", type: "error" },
  { inputs: [], name: "OnlyCallableFromCoordinator", type: "error" },
  { inputs: [], name: "OnlyCallableFromLink", type: "error" },
  { inputs: [{ internalType: "bytes32", name: "id", type: "bytes32" }], name: "RouteNotFound", type: "error" },
  {
    inputs: [{ internalType: "address", name: "sender", type: "address" }],
    name: "SenderMustAcceptTermsOfService",
    type: "error",
  },
  { inputs: [], name: "TimeoutNotExceeded", type: "error" },
  {
    inputs: [{ internalType: "uint16", name: "maximumConsumers", type: "uint16" }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "bytes32", name: "proposedContractSetId", type: "bytes32" },
      { indexed: false, internalType: "address", name: "proposedContractSetFromAddress", type: "address" },
      { indexed: false, internalType: "address", name: "proposedContractSetToAddress", type: "address" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "address", name: "coordinator", type: "address" },
      { indexed: false, internalType: "address", name: "transmitter", type: "address" },
      { indexed: false, internalType: "enum FunctionsResponse.FulfillResult", name: "resultCode", type: "uint8" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bytes", name: "callbackReturnData", type: "bytes" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "bytes32", name: "requestId", type: "bytes32" },
      { indexed: true, internalType: "bytes32", name: "donId", type: "bytes32" },
      { indexed: true, internalType: "uint64", name: "subscriptionId", type: "uint64" },
      { indexed: false, internalType: "address", name: "subscriptionOwner", type: "address" },
      { indexed: false, internalType: "address", name: "requestingContract", type: "address" },
      { indexed: false, internalType: "address", name: "requestInitiator", type: "address" },
      { indexed: false, internalType: "bytes", name: "data", type: "bytes" },
      { indexed: false, internalType: "uint16", name: "dataVersion", type: "uint16" },
      { indexed: false, internalType: "uint32", name: "callbackGasLimit", type: "uint32" },
      { indexed: false, internalType: "uint96", name: "estimatedTotalCostJuels", type: "uint96" },
    ],
    name: "RequestStart",
    type: "event",
  },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "uint64", name: "subscriptionId", type: "uint64" },
      { indexed: false, internalType: "address", name: "fundsRecipient", type: "address" },
      { indexed: false, internalType: "uint256", name: "fundsAmount", type: "uint256" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint96", name: "costWithoutCallback", type: "uint96" },
    ...
    name: "fulfill",
    outputs: [
      { internalType: "enum FunctionsResponse.FulfillResult", name: "resultCode", type: "uint8" },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "uint64", name: "initiatedRequests", type: "uint64" },
          { internalType: "uint64", name: "completedRequests", type: "uint64" },
        ],
  ...
  {
    inputs: [
      { internalType: "uint64", name: "subscriptionIdStart", type: "uint64" },
      { internalType: "uint64", name: "subscriptionIdEnd", type: "uint64" },
    ],
  ...
  {
    inputs: [
      { internalType: "bytes32[]", name: "proposedContractSetIds", type: "bytes32[]" },
      { internalType: "address[]", name: "proposedContractSetAddresses", type: "address[]" },
    ],
